...
Nous avons également deux autres hyper-paramètre important permettant de changer radicalement la construction de l'arbre et l'efficacité de celui-ci. Le premier concerne la génération de test. Nous pouvons généré un test pour splitter les labels en fonction de la moyenne ou de la médiane des features. Le second hyper-paramètre permet de modifier le calcul du score d'un test.
